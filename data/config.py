...
NARRATIVE = {
    "fr": {
        ...
        "intro": (
            ...
            "soutenue par la Fondation Rockefeller, SEorALL et GEA, qui vise à fournir un accès à l'électricité à 300 millions d'Africains d'ici 2030" 
    ...
    "en": {
        ...
        "intro": (
            "Mission 300 (M300) is a joint initiative by the World Bank Group and the African Development Bank (AfDB)," 
            "supported by The Rockefeller Foundation, SEorALL, GEA, which aims to provide electricity access to 300 million Africans by 2030." 
        ...
        "mission": (
            ...
            "national energy pacts that set ambitious targets with specific timelines for: (i) developing energy infrastructure at competitive costs," 
